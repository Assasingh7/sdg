  ...
  return (
    <>
      ...
      <section id="news">
        <div className="section-hdr">
          <div className="section-hdr-left">
            <p className="sh-eyebrow">Media</p>
            <h2 className="sh-title">Latest <em>News</em></h2>
          </div>
          <a href="#" className="sh-link">All News &rarr;</a>
        </div>
        <div className="news-section">
          <div className="news-grid">
            <div className="news-item featured" onClick={() => openCarousel('spice')} style={{ cursor: 'pointer' }}>
              <div className="news-img"><div className="news-img-bg ni1"></div></div>
              <p className="news-cat">Project Spotlight</p>
              <h3 className="news-title">The Spice Route — A Culinary Sanctuary in the Hills of Nainital</h3>
              <p className="news-date">May 2026</p>
            </div>
            <div className="news-item" onClick={() => openCarousel('zola')} style={{ cursor: 'pointer' }}>
              <div className="news-img"><div className="news-img-bg ni2"></div></div>
              <p className="news-cat">New Opening</p>
              <h3 className="news-title">ZOLA Sky Lounge Opens High Above Hyderabad</h3>
              <p className="news-date">April 2026</p>
            </div>
            <div className="news-item" onClick={() => openCarousel('angaar')} style={{ cursor: 'pointer' }}>
              <div className="news-img"><div className="news-img-bg ni3"></div></div>
              <p className="news-cat">New Opening</p>
              <h3 className="news-title">Angaar — Bold, Avant-Garde Dining Comes to Ambala</h3>
        ...
        <div className="news-list-section">
          <ul className="news-list">
            {[
              { key: 'ace', title: 'The Ace Hotel — European Elegance Reborn in New Delhi', date: 'Feb 2026' },
              { key: 'oasis', title: 'Oasis — An Egyptian Narrative in the Heart of New Delhi', date: 'Jan 2026' },
              { key: 'madman', title: 'Madman Lounge & Resort — Himalayan Serenity in Punakha', date: 'Dec 2025' },
              { key: 'tulips', title: 'Red Tulips — A Masterclass in Grand Banquet Design, Kundli', date: 'Nov 2025' },
              { key: 'supreme', title: 'Supreme Workspace — Reimagining Co-working in Gurgaon', date: 'Oct 2025' },
              { key: 'bois', title: 'Bois Blanc — A Tropical Speakeasy in Madagascar', date: 'Sep 2025' },
            ].map((item) => (
              <li key={item.key} className="news-list-item" onClick={() => openCarousel(item.key)} style={{ cursor: 'pointer' }}>
                <span className="nli-cat">Project</span>
                <span className="nli-title">{item.title}</span>
                <span className="nli-date">{item.date}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="studios">
        <div className="studios-header">
          <div className="section-hdr-left" style={{ padding: 0 }}>
            <p className="sh-eyebrow">Our Presence</p>
            <h2 className="sh-title">Our <em>Studio</em></h2>
          </div>
          <a href="#" className="sh-link">All Locations &rarr;</a>
        </div>
        <div className="studios-grid">
          <div className="studio-item">
            <div className="studio-img si1"></div>
            <div className="studio-overlay"></div>
            <div className="studio-content">
              <div className="studio-city">Najafgarh, New Delhi</div>
              <div className="studio-country">India &mdash; Est. 2018</div>
            </div>
          </div>
          <div className="studio-item">
            <div className="studio-img si2"></div>
            <div className="studio-overlay"></div>
            <div className="studio-content">
              <div className="studio-city">Mahesh Garden</div>
              <div className="studio-country">Najafgarh, New Delhi</div>
            </div>
          </div>
          <div className="studio-item">
            <div className="studio-img si3"></div>
            <div className="studio-overlay"></div>
            <div className="studio-content">
              <div className="studio-city">Design Studio</div>
              <div className="studio-country">New Delhi &mdash; 110043</div>
            </div>
          </div>
          <div className="studio-item">
            <div className="studio-img si4"></div>
            <div className="studio-overlay"></div>
            <div className="studio-content">
              <div className="studio-city">Shokeen Design Group</div>
              <div className="studio-country">Main Najafgarh Bahadurgarh Road</div>
            </div>
          </div>
        </div>
      </section>
